...
# -*- coding: utf-8 -*-
"""
This module contains the main land bidding game which maintains the board, score,
and, players.
...
from utilities import find_lines, get_possible_moves, play_move, get_score
...
class BiddingGameManager(object):
